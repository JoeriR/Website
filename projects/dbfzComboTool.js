...
function redrawTable() {
    ...
    comboMoveIds.forEach(function(moveId) {
        ...
        let scaledDamage = move.damage * scaling;
        scaledDamage = Math.trunc(scaledDamage);    // Turn the floating point into an int, kinda

        comboCurrentDamage += scaledDamage;

        let scalingPercentage = Math.trunc(scaling * 100) + "%"
